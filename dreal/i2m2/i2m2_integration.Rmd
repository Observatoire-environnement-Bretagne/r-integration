...
```{r tables_bdd}
tbl(con_oeb_calcul_i2m2,"oeb_i2m2")%>%collect()%>%
...
tbl(con_oeb_calcul_i2m2,"oeb_i2m2_outilsdiag") %>% 
  select(Code_entite_geographique,
           Lible_entite_geographique,
           CoordX_WGS84,
           CoordY_WGS84,
           ...
           Serie,
           Resultat)%>%
  union(tbl(con_oeb_calcul_i2m2,"oeb_i2m2"))%>%
...
tbl(con_oeb_calcul_i2m2,"oeb_i2m2") %>% 
