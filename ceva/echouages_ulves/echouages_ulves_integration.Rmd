...
#dbWriteTable(con_mysql_local, "oeb_donnees_ceva", oeb_donnees_ceva, overwrite=TRUE, append=FALSE,
                             encoding = "latin1")

#dbWriteTable(con_mysql_local, "oeb_ceva_tbi", oeb_ceva_tbi, overwrite=TRUE, append=FALSE,
                             encoding = "latin1")
```
...
oeb_donnees_ceva %>%
  ...
  filter(substr(Periode,6,9) == '2019' & 
        ...
        (Serie == 'Surface cumulée interannuelle (mai septembre - 3_inv)' & Type_Site == 'SABLEUX'
  ...
  write.table(paste0(params$chemin_destination,"/GEOB/oeb_eau_algues_vertes_carte.csv"), quote=FALSE, sep=';', row.names = FALSE)
```
